...
void PlayingCardDisplay::drawCard(U8G2 &display, uint8_t cardIndex) const
{
    const PlayingCard playingCard = getCard(cardIndex % cardCount);
...
void PlayingCardDisplay::drawClubSuit(U8G2 &display, uint8_t originX, uint8_t originY) const
{
    ...
    display.drawTriangle(originX + 17, originY + 20, originX + 10, originY + 34, originX + 24, originY + 34);
    display.drawBox(originX + 13, originY + 28, 9, 6);
}

void PlayingCardDisplay::drawSpadeSuit(U8G2 &display, uint8_t originX, uint8_t originY) const
{
    display.drawDisc(originX + 10, originY + 22, 10, U8G2_DRAW_ALL);
    display.drawDisc(originX + 24, originY + 22, 10, U8G2_DRAW_ALL);
    display.drawTriangle(originX + 1, originY + 19, originX + 33, originY + 19, originX + 17, originY);
    display.drawTriangle(originX + 17, originY + 18, originX + 10, originY + 34, originX + 24, originY + 34);
    display.drawBox(originX + 13, originY + 28, 9, 6);
}
